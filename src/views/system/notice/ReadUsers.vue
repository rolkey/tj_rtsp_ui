<template>
  <el-dialog draggable v-model="visible" :title="`「${noticeTitle}」已读用户`" width="760px" top="6vh" append-to-body @close="handleClose">
    ...
    <el-table border v-loading="loading" :data="userList" size="small" stripe height="340px">
